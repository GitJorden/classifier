...
def GetDataColumns(dataFrame):
    ...
    ProcNum = dataFrame['ProcNum']
    ActiveSlide = dataFrame['ActiveSlide']
    DurationSlide = dataFrame['DurationSlide']
    CenterIm = dataFrame['CenterIm']
    PerIm = dataFrame['PerIm']
    ...
    ProcNum = numpy.array(ProcNum)
    ActiveSlide = numpy.array(ActiveSlide)
    DurationSlide = numpy.array(DurationSlide)
    CenterIm = numpy.array(CenterIm)
    ...
    ProcNum = ProcNum.reshape(ProcNum.size, 1)
    ActiveSlide = ActiveSlide.reshape(ActiveSlide.size, 1)
    DurationSlide = DurationSlide.reshape(DurationSlide.size, 1)
    CenterIm = CenterIm.reshape(CenterIm.size, 1)
    PerIm = PerIm.reshape(PerIm.size, 1)
    ...
    return TETTime, \
           ...
           TrialProc, ProcNum, ActiveSlide, DurationSlide, CenterIm, PerIm, AOIStimulus
